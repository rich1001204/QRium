...
package org.qrium.yrq.database;
...
public class Converters {
    ...
    @TypeConverter
    public static int typeToInt(org.qrium.yrq.objects.Type type) {
        return type.getTypeInt();
    }

    @TypeConverter
    public static org.qrium.yrq.objects.Type intToType(int typeInt) {
        return org.qrium.yrq.objects.Type.getTypeFromCode(typeInt);
    }
