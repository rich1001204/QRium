...
package com.rich1001204.qrium.database;
...
public class Converters {
    ...
    @TypeConverter
    public static int typeToInt(com.rich1001204.qrium.objects.Type type) {
        return type.getTypeInt();
    }

    @TypeConverter
    public static com.rich1001204.qrium.objects.Type intToType(int typeInt) {
        return com.rich1001204.qrium.objects.Type.getTypeFromCode(typeInt);
    }
